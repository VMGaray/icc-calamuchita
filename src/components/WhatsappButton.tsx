const WHATSAPP_URL =
  "https://wa.me/543546500950?text=Hola%20Steel%20Mafa%2C%20quiero%20hacer%20una%20consulta";

const variants = {
  orange: "bg-accent-orange hover:bg-accent-orange/85",
  green: "bg-accent-green hover:bg-accent-green/85",
};
...
export default function WhatsappButton({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-md px-6 py-3 font-semibold text-white transition-colors ${variants[variant]} ${className}`}
    >
